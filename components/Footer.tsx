...
export function Footer() {
  ...
  return (
    <footer className="bg-zinc-100 dark:bg-zinc-900 border-t border-zinc-200 dark:border-zinc-800 pb-safe">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 text-sm mb-4 max-w-md">
              ...
              Browse waifus, nekos, and more with infinite scroll, semantic
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 text-center md:text-left">
              <p className="text-zinc-500 dark:text-zinc-500 text-sm">
                © <span suppressHydrationWarning>{currentYear}</span> Waifu
                Gallery.
              </p>
              <p className="hidden md:block text-zinc-300 dark:text-zinc-700">
                |
              </p>
              <p className="text-zinc-500 dark:text-zinc-500 text-sm">
                Powered by{" "}
