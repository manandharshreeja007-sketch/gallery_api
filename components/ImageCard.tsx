  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          "absolute top-2 right-2 sm:top-3 sm:right-3 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-full transition-all duration-300",
          "sm:transform sm:translate-y-2 sm:opacity-0 sm:group-hover:translate-y-0 sm:group-hover:opacity-100",
          isFav
      ...
      {showCategory && categoryInfo && (
        <div
          className={cn(
            "absolute top-2 left-2 sm:top-3 sm:left-3 px-2 py-1 sm:px-3 rounded-full text-xs font-medium",
