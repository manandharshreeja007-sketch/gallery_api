...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with the Waifu Gallery team. We'd love to hear your feedback, suggestions, and bug reports.",
  alternates: {
    canonical: "https://waifugallery.netlify.app/contact",
  },
};
    ...
    <div className="container mx-auto px-4 py-12 max-w-2xl">
      ...
      <div className="bg-card border border-border rounded-xl p-8 shadow-sm">
        <p className="text-lg text-center mb-8 text-foreground/80">
          Have a suggestion, found a bug, or just want to say hello? We'd love
          to hear from you.
        </p>
